          ...
          <div className='flex flex-col items-center space-y-4 text-center'>
            <div className='space-y-2'>
              ...
              <p className='mx-auto max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                ...
                explore their creativity. Our platform combines cutting-edge AI
                technology with engaging storytelling to create a unique
              ...
              <p className='mx-auto max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed'>
                Our AI-powered system adapts to each child&apos;s learning
                style, ensuring that every adventure is tailored to their
                individual needs and interests. From magical quests to
                scientific explorations, AI Adventures opens up a world of
                possibilities for young minds to grow and thrive.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className='container px-4 md:px-6'>
          <div className='flex flex-col items-center space-y-4 text-center'>
            ...
            <p className='text-2xl font-bold'>Próximamente más herramientas</p>
          </div>
        </div>
      </FadeInContainer>
    </main>
